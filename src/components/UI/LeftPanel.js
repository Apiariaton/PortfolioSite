...
function LeftPanel(props){
    if (props.size === "desktop")
    {
        ...
        <div className="profile_description_desktop">William Holder<br/> <div className="profile_description_sub_text_desktop"><a href="https://www.linkedin.com/in/william-holder-b13151244/"> Front-End Developer </a> </div></div>
        </div>
